...
, postgresql-simple-migration, resource-pool, rio, rio-orphans
, servant, servant-auth, servant-auth-server, servant-conduit
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    postgresql-simple-migration resource-pool rio rio-orphans servant
