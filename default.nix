...
, rio, rio-orphans, servant-auth, servant-auth-server, servant-conduit, servant-server, stdenv
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    postgresql-simple-migration resource-pool rio rio-orphans servant-auth
