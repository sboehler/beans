...
The beans binary will be made available in ./new-dist/build/beans/beans
and can be run from there.
...
#+NAME: beans-help
#+BEGIN_SRC sh :exports both :results output :var PATH="./new-dist/build/beans"
  beans --help
#+END_SRC
...
#+BEGIN_SRC sh :exports both :results output verbatim :var PATH="./new-dist/build/beans"
